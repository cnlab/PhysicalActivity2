...
3. Scanner task description
    ...
    3. For the full list of health messages, see [affirmation_stimuli.csv](https://github.com/prateekshitcnlab/PhysicalActivity2/blob/master/tasks/affirmation%20task/affirmation_stimuli.csv)
